...
public class WildfireCreditsScreen extends BaseWildfireScreen {
    ...
    public void render(DrawContext ctx, int mouseX, int mouseY, float delta) {
        ...
        for (int i = startIndex; i < endIndex; i++) {
            ...
            mStack.translate(-xP, (-yP) - 47);
            GuiUtils.drawScrollableTextWithoutShadow(GuiUtils.Justify.CENTER, ctx, textRenderer, Text.literal(creditBox.getName()), (int)(xP - (52 * 1.45f)/2), yP + 7, (int) (xP + (52 * 1.45f)/2), yP + 7 + textRenderer.fontHeight, ColorHelper.fullAlpha(0xFFFFFF));
            mStack.popMatrix();
